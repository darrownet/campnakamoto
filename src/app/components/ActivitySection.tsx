...
const ActivitySection: React.FC = () => {
  return (
    <SectionWrapper id="activities" title="Activities">
      ...
      <ul>
          <li><i>🎤</i><strong>Speakers Series</strong>: Engage with the luminaries of the bitcoin community. Learn, question, and be inspired by industry leaders who&apos;ve been continuing down the rabbit hole longer than most of us.</li>
      </ul>
      ...
      <ul>
          ...
          <li><i>🍸</i><strong>Cocktail Hour Nightly</strong>: Unwind, network, or discuss the day&apos;s gains over crafted cocktails. Here, &apos;mixing&apos; isn&apos;t just for <strike>sats</strike> drinks but for ideas too.</li>
      ...
      <p>At <strong>Camp Nakamoto</strong>, every activity is a node in the network of your camp experience, linking you to new friends, skills, and maybe even your next big investment idea. Dive into activities that are as diverse as the bitcoin&apos;s ecosystem.</p>
    </SectionWrapper>
  );
};
