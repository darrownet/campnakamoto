...
const faqsData = [
  ...
  },
  {
    ...
    content: <p>Yes, but we encourage digital detox sessions. However, for those critical times when you just can&pos;t wait for Bitcoin&apos;s next block, Wi-Fi will be available. Remember, we&apos;re connecting with nature <i>and</i> the network.</p>
  },
  {
